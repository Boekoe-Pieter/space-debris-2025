...
def ukf_2(state_params, meas_dict, sensor_params, int_params, filter_params, bodies,start):    
    '''
    This function implements the Unscented Kalman Filter for the least
    squares cost function.
    ...
    # Measurement times
    tk_list = meas_dict['tk_list'][start:]
    Yk_list = meas_dict['Yk_list'][start:]
...
def ukf_altered(state_params, meas_dict, sensor_params, int_params, filter_params, bodies,cutoff):    
    '''
    This function implements the Unscented Kalman Filter for the least
    squares cost function.
